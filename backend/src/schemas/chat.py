...
class ChatUpdate(BaseModel):
    ...
    model: Optional[str] = Field(
        ...
        min_length=1,
        max_length=100,
        description="Change AI model for this chat"
    )
    ...
    pinned: Optional[bool] = Field(
        None,
        description="Pin/unpin chat in user's chat list"
    )
    ...
    temperature: Optional[float] = Field(
        ...
        ge=0.0,
        le=2.0,
        description="AI creativity/randomness (0.0-2.0)"
    )
    ...
    is_deleted: Optional[bool] = Field(
        None,
        description="Soft delete flag - hides chat without permanent deletion"
    )
